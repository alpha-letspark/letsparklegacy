...
{
   $updateSql= "UPDATE details_transaction SET status='1',foc='1', amount='0', exit_time='$exit_time' where card_number = '$card_number' and status= 0";
...
$transaction_id = $row['transaction_id'];
	...
	$data = array("status" => success,"data" => $status , "message" => "foc updated successfully"   );
