...
$sql = "select transaction_id,vehicle_type,entry_time,exit_time,amount,area from details_transaction where vehicle_number = '$vehicle_number' AND status= 0 ";
...
{
   $updateSql= "UPDATE details_transaction SET status='1',amount='$amount', exit_time='$exit_time' , exit_user_id ='$exit_user_id' , exit_pay ='$amount_due'  where vehicle_number = '$vehicle_number' AND status= 0";
