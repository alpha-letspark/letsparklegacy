...
and DATE_FORMAT(redemption_shopowner.created_at,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(redemption_shopowner.created_at,'%Y-%m-%d') <= '$date2' and redemption_shopowner.shopowner_id = $shopowner_id";
