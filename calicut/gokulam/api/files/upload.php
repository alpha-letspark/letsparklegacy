...
function upload_file($encoded_string){
    ...
    try {
        ...
        $data = array("success" => 1, "message" => "File Uploaded Successfully");
...
// Check connection
    ...
    $sql = "INSERT INTO uploaded_files (file_name, remarks, card_number,transaction_id,path )VALUES ('$file' , '$remarks' ,'$card_number','$transaction_id','$file_dir')";
    $conn->query($sql);
    $conn->close();
...
//$final = $_POST["final"];
$encoded_string = !empty($_POST['base64_file']) ? $_POST['base64_file'] : "$image";
