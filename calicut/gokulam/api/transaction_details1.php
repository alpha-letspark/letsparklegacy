...
if ($card_number == "" && $vehicle_type == "2" &&  $area == "1"   )  { 
$amount = "30";
$statusnew = "1" ;
...
else if ($card_number == "" && $vehicle_type == "4" &&  $area == "1"   )  { 
$amount = "40";
$statusnew = "1" ;
...
else if ($card_number == "" && $vehicle_type == "3" &&  $area == "1"   )  { 
$amount = "50";
$statusnew = "1" ;
...
$query = "INSERT INTO details_transaction (userid,transaction_id,vehicle_type,entry_time,amount,client_id,vehicle_number,redemption_id,flag,status, area,card_number, card_type) VALUES ('$client_id','$transaction_id','$vehicle_type','$entry_time','$amount','$client_id','$vehicle_number','$redemption_id','$flag','$statusnew' ,'$area' , '$card_number' , '$card_type')";
      ...
      $data = array("success" => 1, "message" => "Successfully added transaction details!" , "amount" => $amount , "area" => $area, "price" => $price , "gst" => $gst , "transaction_id" => $transaction_id, "card_number" => $card_number ,  "vehicle_number" => $vehicle_number , "status" => $statusnew , "status" => $statusnew);

}

else if ($card_number == "" && $vehicle_type == "5" &&  $area == "1"   )  { 
$amount = "60";
$statusnew = "1" ;
...
else if ($card_number == "" && $vehicle_type == "6" &&  $area == "1"   )  { 
$amount = "80";
$statusnew = "1" ;
...
else if ($card_number == "" && $vehicle_type == "7" &&  $area == "1"   )  { 
$amount = "100";
$statusnew = "1" ;
...
else if ($card_number == "" && $vehicle_type == "10" &&  $area == "1"   )  { 
$amount = "50";
$statusnew = "1" ;
