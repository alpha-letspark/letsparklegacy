...
$sql9 = "SELECT name from cms_users where id = '$employee_id'";
$result9 = mysqli_query($con,$sql9);
$name1=mysqli_fetch_row($result9);
$name = implode(',', $name1);
...
$data = array("result" => 1, "all_vehicle" =>  array($data1,$data3), "area" => "basement" ,"foc_count" =>$foc_count, "total" => $total_final , "from" => "$date1" , "to" => "$date2" , "report_type" => "Userwise" ,"name" => "$name"   );
