...
$query1 = "select count(id) as two_wheeler_slot from details_transaction where vehicle_type = '2' and status ='0'";
$result1 = mysqli_query($con,$query1);
$two_wheeler_slot=mysqli_fetch_row($result1);

if($result1){

$query2 = "select count(id) as four_wheeler_slot from details_transaction where vehicle_type = '4' and status ='0'";
