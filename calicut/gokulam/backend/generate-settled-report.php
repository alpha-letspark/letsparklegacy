            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Today's Settled Report </a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="settled-shopowner-list-view.php">
                                    <p class="category"><img src="icons/redemption.png"  style="width:60px"> Settled Transaction</p>
                                    <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT COUNT(redemption_id) as statu FROM  redemption_shopowner where shopowner_id = '$shopowner_id' and DATE_FORMAT(created_at,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(created_at,'%Y-%m-%d') <= '$date2'and redemption_flag='0'") or die(mysql_error());
//  echo $q1;
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="settled-shopowner-list-view.php">
                                    <p class="category"><img src="icons/redemrupee.png"  style="width:55px">Total Amt Settled</p>
                                                                        <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT SUM(amount_redemmed) as sumnewrow FROM  redemption_shopowner where  shopowner_id = '$shopowner_id' and DATE_FORMAT(created_at,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(created_at,'%Y-%m-%d') <= '$date2' and redemption_flag='0'") or die(mysql_error());
...
?>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="settled-shopowner-list-view.php">
                                    <p class="category"><img src="icons/redemptionbike.png"  style="width:60px">No of Settled 2W</p>
                                                                                                          <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT count(redemption_id) as vec FROM redemption_shopowner where shopowner_id = '$shopowner_id' and DATE_FORMAT(created_at,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(created_at,'%Y-%m-%d') <= '$date2' and vehicle_type = '2' and redemption_flag='0'") or die(mysql_error());
...
?>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="settled-shopowner-list-view.php">
                                    <p class="category"><img src="icons/redemptioncar.png"  style="width:60px">No of Settled 4W </p>
                                                                        <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT count(redemption_id) as vec FROM redemption_shopowner where  shopowner_id = '$shopowner_id' and DATE_FORMAT(created_at,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(created_at,'%Y-%m-%d') <= '$date2' and vehicle_type = '4' and redemption_flag='0'") or die(mysql_error());
...
?>
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="settled-shopowner-list-view.php">
                                    <p class="category"><img src="icons/redemptionbike.png"  style="width:60px">Amt Settled from 2W </p>
                                                                        <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT SUM(amount_redemmed) as sumnewrow FROM  redemption_shopowner where  shopowner_id = '$shopowner_id' and DATE_FORMAT(created_at,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(created_at,'%Y-%m-%d') <= '$date2' and redemption_flag='0' and vehicle_type='2'") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="settled-shopowner-list-view.php">
                                    <p class="category"><img src="icons/redemptioncar.png"  style="width:60px">Amt Settled from 4W </p>
                                                                        <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT SUM(amount_redemmed) as sumnewrow FROM  redemption_shopowner where shopowner_id = '$shopowner_id' and DATE_FORMAT(created_at,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(created_at,'%Y-%m-%d') <= '$date2' and redemption_flag='0' and vehicle_type='4'") or die(mysql_error());
