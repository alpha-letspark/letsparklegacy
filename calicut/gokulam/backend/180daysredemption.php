...
include("config.php");
$curdate=  date('Y-m-d');
$lastsevendays= date('Y-m-d', strtotime('-180 days'));
session_start();
//echo $_SESSION['name'];
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Last 6  Months Redemption Report </a>
                    </div>
...
<div class="toolbar">  <div class="dropdown">
	...
	$q1 =  mysql_query("SELECT COUNT(redemption_id) as statu FROM  redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') > '$lastsevendays' and DATE_FORMAT(created_at,'%Y-%m-%d') < '$curdate' ") or die(mysql_error());
//	echo $q1;
...
<?php } ?>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category"><img src="icons/redemrupee.png"  style="width:60px">Total Amt Redemmed</p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT SUM(amount_redemmed) as sumnewrow FROM  redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') > '$lastsevendays' and DATE_FORMAT(created_at,'%Y-%m-%d') < '$curdate'") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category"><img src="icons/redemptionbike.png"  style="width:60px">No of Two Wheelers</p>
                                                                                                          <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec from redemption_shopowner where vehicle_type = 2 and  DATE_FORMAT(created_at,'%Y-%m-%d') > '$lastsevendays' and DATE_FORMAT(created_at,'%Y-%m-%d') < '$curdate'") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category"><img src="icons/redemptioncar.png"  style="width:60px">No of Four Wheelers</p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec from redemption_shopowner where vehicle_type = 4 and  DATE_FORMAT(created_at,'%Y-%m-%d') > '$lastsevendays' and DATE_FORMAT(created_at,'%Y-%m-%d') < '$curdate'") or die(mysql_error());
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    ...
                                    <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT count(*) FROM `details_transaction`  where vehicle_type = '2' and amount = '0' and status = '0' and DATE_FORMAT(entry_time,'%Y-%m-%d') > '$lastsevendays' and DATE_FORMAT(entry_time,'%Y-%m-%d') < '$curdate' ") or die(mysql_error());
//	echo $q1;
	while($row2 = mysql_fetch_array($q1)){
?>
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category">Total trans under 15 min 4W</p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT count(*) FROM `details_transaction`  where vehicle_type = '4' and amount = '0' and status = '0' and DATE_FORMAT(entry_time,'%Y-%m-%d') > '$lastsevendays' and DATE_FORMAT(entry_time,'%Y-%m-%d') < '$curdate' ") or die(mysql_error());
...
?>
 ...
 // $strQuery = "SELECT DISTINCT category, value1, value2, value3 FROM mscombi2ddata; ";
  ...
  $strQuery = "SELECT DISTINCT DATE_FORMAT(created_at,'%Y-%m-%d') as date, sum(amount_redemmed) as amount  from `redemption_shopowner` where DATE_FORMAT(created_at,'%Y-%m-%d') > '$lastsevendays' and DATE_FORMAT(created_at,'%Y-%m-%d') < '$curdate' group by DATE_FORMAT(created_at,'%Y-%m-%d') ";
