                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="toolbar">
                                       ...
                                       <a href="redemption_report.php"> <input id="gobutton" type="submit" value="Go Back" class="btn bg-teal-400" name="submit" style=" background-color: #ff7900;position: relative;"></a>
                                    </div>
...
FROM
    redemption_shopowner inner join login where redemption_shopowner.shopowner_id = login.id and DATE_FORMAT(created_at,'%Y-%m-%d') = '$date1' ");
...
?> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $rowc['shop'];?></td>
                                                    <td><?php echo $rowc['amount_redemmed'];?></td>
