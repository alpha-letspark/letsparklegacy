...
if (isset($_GET['edit']))
	{
		$id = $_GET['edit'];
		$update= true;
		$record = mysqli_query($db, "SELECT * FROM cms_users WHERE id=$id");
		if(count($record) == 1 )
		{
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Add Attendant </a>
                    </div>
                                    ...
                                    <div class="card-content" >
                                        <!--<h4 class="card-title"><b>Request Parking Cards</b></h4>-->
                                         ...
                                         <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" name="username" type="text" value="<?php echo $email; ?>" required autocomplete="off">
                                        </div> 
										<div class="form-group label-floating">
