            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">4W Transaction under 15 min List view</a>
                    </div>
                    ...
                    <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">4W Transaction under 15 min List view</h4>
...
// $user_id =  $_SESSION['id'];
	...
	$query = ("SELECT transaction_id,redemption_id,vehicle_type,vehicle_number,amount,entry_time, exit_time, (TIME_TO_SEC(exit_time) - TIME_TO_SEC(entry_time)) AS duration, (CASE WHEN status = '1' THEN 'Completed' ELSE 'Running' END ) as status,  (CASE WHEN area = '1' THEN 'Basement' ELSE 'Surface' END ) as area
               FROM details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$curdate' and vehicle_type = 4 and (TIME_TO_SEC(exit_time) - TIME_TO_SEC(entry_time)) <= 900");
