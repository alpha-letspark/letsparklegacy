                    ...
                    <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <h4 class="card-title"><b>Card List</b></h4>
                                    <div class="toolbar">
...
// $user_id =  $_SESSION['id'];
 ...
 $query = ("select id,card_number,(CASE WHEN type = '1' THEN 'Privilage'  WHEN type = '2' THEN 'Free'  WHEN type = '3' THEN 'Employee'  WHEN type = '4' THEN '4-Wheeler' WHEN type = '5' THEN '2-Wheeler' END)  as type,(CASE WHEN status = '1' THEN 'Active' ELSE 'Inactive' END ) as status,valid_from,valid_to,(CASE WHEN approval_status = '1' THEN 'Approved' ELSE 'Not Approved' END ) as approval_status,created_date  from card_details");
...
?> 
                                                ...
                                                <tr>
													...
													<td><?php echo $rowc['approval_status'];?></td>
													<td class="td-actions">
													<a href="edit_card.php?edit=<?php echo $rowc['id'];?>" >
