...
<div class="card-content" align="center">
                            <h4 class="card-title"><b>Money Collected Remarks</b></h4>

<?php
if (isset($_POST['submit']))
{
    ?>
     <p style="font-size: 18px;"> Date From: <b><?php echo $date1; ?>&nbsp;&nbsp; &nbsp;  </b>Date to: <b><?php echo $date2 ?> </b> </p>
     <?php
}
else
{
    ?>
    <p style="font-size: 18px;"> Date From: <b><?php echo $date4; ?>&nbsp;&nbsp; &nbsp;  </b>Date to: <b><?php echo $date3 ?> </b> </p>
    <?php
}
?>
                    ...
                    <div class="row" >
                    <form name="form2" method="post" id="" action="#"  >
                        <div class="col-sm-4">
                            <div class="card">
...
if (isset($_POST['submit']))
{
	$query = ("SELECT mcremarks.id,mcremarks.remarks,mcremarks.actual_amount,mcremarks.amount_collected,mcremarks.user_id,mcremarks.created_at,cms_users.name from mcremarks inner join cms_users where mcremarks.user_id = cms_users.id and DATE_FORMAT(mcremarks.created_at,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(mcremarks.created_at,'%Y-%m-%d')   <= '$date2' order by mcremarks.id desc");

}
else
{
	$query = ("SELECT mcremarks.id,mcremarks.remarks,mcremarks.actual_amount,mcremarks.amount_collected,mcremarks.user_id,mcremarks.created_at,cms_users.name from mcremarks inner join cms_users where mcremarks.user_id = cms_users.id and DATE_FORMAT(mcremarks.created_at,'%Y-%m-%d')   >= '$date4' and DATE_FORMAT(mcremarks.created_at,'%Y-%m-%d')   <= '$date3'order by mcremarks.id desc");
...
?> 
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td><?php echo $rowc['actual_amount'];?></td>
                                                    <td><?php echo $rowc['amount_collected'];?></td>
