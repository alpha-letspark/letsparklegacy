                ...
                <div class="container-fluid">
                            ...
                            <div class="card">
                                ...
                                <form id="RegisterValidation" action="" method="post">
                                    ...
                                    <div class="card-content">
                                        <h4 class="card-title"><b>Add Employee</b></h4>
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" name="shop_name" id="pass" type="text" required="" autocomplete="off">
                                        </div>
										 <div class="form-group label-floating">
										 DOJ
											<label class="control-label">
                                            ...
                                            <input class="form-control" name="doj" id="dob" type="date" required="" autocomplete="off">
                                        </div>
										 <div class="form-group label-floating">
										 DOB
											<label class="control-label">
                                            ...
                                            <input class="form-control" name="dob" id="dob" type="date" required="" autocomplete="off">
                                        </div>
                                          <div class="form-group">
                                            	<select class="form-control" name="gender" id ="gender" required  title="Select" data-size="7">
										 ...
										 <div class="form-group">
                                            	<select class="form-control" name="vehicle_type" id ="type" required  title="Select" data-size="7">
										...
										<label class="control-label">
                                              Vehicle Number
										 <input class="form-control" name="vehicle_number" id="vehicle_number" type="text" required="" autocomplete="off">
                                          </label>
                    ...
                    <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><b>Recharge Status</b></h4>
...
// $user_id =  $_SESSION['id'];
	...
	$query = sprintf("SELECT * FROM  employee_list ORDER BY  name ASC");
//	echo $query;
...
?> 
                                                ...
                                                <tr>
													...
													<td><?php echo $rowc['vehicle_number'];?></td>
													 <td ><a href="add_money.php" class="btn btn-rose btn-fill" >Recharge</a></td>
