...
function delete_id(id)
{
     ...
     {
        window.location.href='view_attendant.php?del='+id;
     }
}
</script>
</head>
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Attendants Report</a>
                    </div>
...
// $user_id =  $_SESSION['id'];
    ...
    $query = sprintf("SELECT id,name,email,id_cms_privileges FROM cms_users" );
...
?> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $rowc['id_cms_privileges'];?></td>
                                                    <td class="td-actions">
													<a href="add_attendant.php?edit=<?php echo $rowc['id'];?>">
                                                            <button type="button" rel="tooltip" class="btn btn-success btn-simple" title="Edit" >
