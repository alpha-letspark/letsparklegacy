            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Generate Fine</a>
                    </div>
                    ...
                    <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content" align="center">
                                    <h4 class="card-title"><b>Generate Fine</b></h4>
                                   <p style="font-size: 18px;"> Date From: <b><?php echo $_POST['date1']; ?>&nbsp;&nbsp; &nbsp;  </b>Date to: <b><?php echo $_POST['date2']; ?> </b> </p>
   <?php $q1 =  mysql_query("SELECT SUM(fined_amount) as statu FROM  finedetails where DATE_FORMAT(created_at,'%Y-%m-%d')   >= '$date1' and DATE_FORMAT(created_at,'%Y-%m-%d')   <= '$date2' ") or die(mysql_error());
//  echo $q1;
  while($row2 = mysql_fetch_array($q1)){
         echo "<p style='font-size: 18px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fined Amt: <b>₹ </b>" .$row2['statu']."</p>";
  }   ?>


                    <div class="row" >
                    <form name="form2" method="post" id="" action="generate-fine.php"  >
                        <div class="col-sm-4">
                            <div class="card">
...
// $user_id =  $_SESSION['id'];
    ...
    $query = "Select * from finedetails where DATE_FORMAT(created_at,'%Y-%m-%d')  >= '$date1' and DATE_FORMAT(created_at,'%Y-%m-%d')   <= '$date2'";
//  echo $query;
...
?> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $rowc['fined_amount'];?></td>
