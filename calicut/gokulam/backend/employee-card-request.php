...
if (isset($_GET['id']))
	{
		$id = $_GET['id'];
		mysql_query("UPDATE  employee_allocation set current_status = '2' where id = '$id' ");
		 
		header('location: employee-card-request.php');
	}
...
function delete_id(id)
{
     ...
     {
        window.location.href='employee-card-request.php?id='+id;
     }
}
</script>
</head>
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Employee Card Request</a>
                    </div>
...
?> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-actions">
													<a href="edit-allocation.php?id=<?php echo $rowc['id'];?>" >
