            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Create Shop </a>
                    </div>
                                ...
                                <form id="RegisterValidation" action="" method="post">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" name="pass" id="pass" type="password" required="" autocomplete="off">
                                        </div>
										...
										<label class="control-label">
                                               Business Type
										 <input class="form-control" name="business_type" id="business_type" type="text" required="" autocomplete="off">
                                          </label>
