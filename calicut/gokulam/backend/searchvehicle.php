        ...
        <div class="main-panel">
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> ENTER VEHICLE NUMBER</a>
                    </div>
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <form name="form2" method="post" action="vehicle-search-result.php">
                       <div class="col-xs-3">
                            <div class="card">
       <input type="text" name="vehicle_number" class= "form-control" value="" placeholder="Enter Vehicle Number" autocomplete ="off" />
