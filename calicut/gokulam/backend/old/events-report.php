            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Events DEPARTMENT MIS REPORT </a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">EVENTS Department Report</h4>
						 ...
						 <?php 
		  $user_id =  $_SESSION['id'];
          $query = sprintf("SELECT * FROM  rating  where department='EVENTS' and user_id='$user_id' and date = '$date'");
...
?> 
                                                ...
                                                <tr>
                                                  ...
                                                  <!-- <td><?php echo $rowc['topic'];?></td>-->
                                                    ...
                                                    <td class="text-right">
                                                        <a href="#" class="btn btn-simple"><i class="material-icons"></i></a>
                                                       <!-- <a href="#" class="btn btn-simple btn-danger btn-icon remove"><i class="material-icons">close</i></a>-->
                                                         <a href="#" data-id="<?php echo $rowc['id'] ?>" id="delete" class="btn btn-simple btn-danger btn-icon remove"><i class="material-icons"></i></a>
                                                    </td>
                                                </tr>
											<?php }?>
                                            </tbody>
								 ...
								 <?php 
	$user_id =  $_SESSION['id'];
	$query1 = sprintf("SELECT SUM(rating*actual_share*0.20) as total4 FROM  rating  where department='EVENTS' and topic='team' and user_id='$user_id' and date = '$date' ");
	//echo $query1; 
		...
		//$total = $row['rating'] * $row['actual_share'];
		 ...
		 // echo $mark ;
		  ...
		  // echo "jaffar";
		  	...
		  	$query1 = sprintf("SELECT SUM(rating*actual_share*0.30) as total5 FROM  rating  where department='EVENTS' and topic='OPERATIONAL PLANNING' and user_id='$user_id' and date = '$date' ");
	//echo $query1; 
	$qu1 =  mysql_query($query1) or die(mysql_error());
	while($row1 = mysql_fetch_array($qu1)){
		//extract($rowc); 
		//$total = $row['rating'] * $row['actual_share'];
		 ...
		 // echo $mark ;
		  ...
		  // echo "jaffar";
		  	...
		  	$query1 = sprintf("SELECT SUM(rating*actual_share*0.20) as total3 FROM  rating  where department='EVENTS' and topic='FINANCIALS' and user_id='$user_id' and date = '$date' ");
	//echo $query1; 
	$qu1 =  mysql_query($query1) or die(mysql_error());
	while($row1 = mysql_fetch_array($qu1)){
		//extract($rowc); 
		//$total = $row['rating'] * $row['actual_share'];
		 ...
		 // echo $mark ;
		  ...
		  // echo "jaffar";
			...
			$query1 = sprintf("SELECT SUM(rating*actual_share*0.15) as total1 FROM  rating  where department='EVENTS' and topic='TECHNOLOGY USAGE' and user_id='$user_id' and date = '$date' ");
	//echo $query1; 
	$qu1 =  mysql_query($query1) or die(mysql_error());
	while($row1 = mysql_fetch_array($qu1)){
		//extract($rowc); 
		//$total = $row['rating'] * $row['actual_share'];
		 ...
		 // echo $mark ;
		  ...
		  // echo "jaffar";  
		  	...
		  	$query1 = sprintf("SELECT SUM(rating*actual_share*0.15) as total2 FROM  rating  where department='EVENTS' and topic='BRAND IMAGE' and user_id='$user_id' and date = '$date' ");
	//echo $query1; 
	$qu1 =  mysql_query($query1) or die(mysql_error());
	while($row1 = mysql_fetch_array($qu1)){
		//extract($rowc); 
            ...
            <footer class="footer">
                <div class="container-fluid">
                    ...
                    <p class="copyright pull-right">
                       ...
                       <a href="..\dashboard.html">CSC</a>, People Passion Excellence
                    </p>
                </div>
            </footer>
        </div>
