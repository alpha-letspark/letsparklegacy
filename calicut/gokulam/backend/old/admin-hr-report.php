...
<?php if($_SESSION["id"]==1 ){ ?>
 ...
 //$user_id =  $_SESSION['id'];
	...
	$query = sprintf("SELECT * FROM  rating  where department='HR' and user_id='2' and date = '$date'");
//	echo $query;
...
?> 
 ...
 <?php 
	$user_id =  $_SESSION['id'];
	$query1 = sprintf("SELECT SUM(rating*actual_share*0.3) as total1 FROM  rating  where department='HR' and topic='team' and user_id='2' and date = '$date' ");
	//echo $query1; 
		...
		//$total = $row['rating'] * $row['actual_share'];
		 ...
		 // echo $mark ;
		  ...
		  // echo "jaffar";
		  	...
		  	$query1 = sprintf("SELECT SUM(rating*actual_share*0.4) as total2 FROM  rating  where department='HR' and topic='OPERATIONAL PLANNING' and user_id='2' and date = '$date' ");
	//echo $query1; 
	$qu1 =  mysql_query($query1) or die(mysql_error());
	while($row1 = mysql_fetch_array($qu1)){
		//extract($rowc); 
		//$total = $row['rating'] * $row['actual_share'];
		 ...
		 // echo $mark ;
		  ...
		  // echo "jaffar";
		  	...
		  	$query1 = sprintf("SELECT SUM(rating*actual_share*0.15) as total3 FROM  rating  where department='HR' and topic='FINANCIALS' and user_id='2' and date = '$date' ");
	//echo $query1; 
	$qu1 =  mysql_query($query1) or die(mysql_error());
	while($row1 = mysql_fetch_array($qu1)){
		//extract($rowc); 
		//$total = $row['rating'] * $row['actual_share'];
		 ...
		 // echo $mark ;
		  ...
		  // echo "jaffar";
			...
			$query1 = sprintf("SELECT SUM(rating*actual_share*0.10) as total4 FROM  rating  where department='HR' and topic='TECHNOLOGY USAGE' and user_id='2' and date = '$date' ");
	//echo $query1; 
	$qu1 =  mysql_query($query1) or die(mysql_error());
	while($row1 = mysql_fetch_array($qu1)){
		//extract($rowc); 
		//$total = $row['rating'] * $row['actual_share'];
		 ...
		 // echo $mark ;
		  ...
		  // echo "jaffar";  
		  	...
		  	$query1 = sprintf("SELECT SUM(rating*actual_share*0.05) as total5 FROM  rating  where department='HR' and topic='BRAND IMAGE' and user_id='2' and date = '$date' ");
	//echo $query1; 
	$qu1 =  mysql_query($query1) or die(mysql_error());
	while($row1 = mysql_fetch_array($qu1)){
		//extract($rowc); 
