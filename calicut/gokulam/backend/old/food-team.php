...
if(isset($_POST['submit'] ))
{
  ...
  // $next_date=date('Y-m-d', strtotime('+1 months'));
    $sq = "SELECT * from rating WHERE date = '$currentDate' and user_id='$user_id' and topic = 'team' and department='FOOD AND BEVERAGE'"; 
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">FOOD DEPARTMENT (TEAM)
                                            ...
                                            <div class="col-md-">
                                                <div class="form-group label-floating">
                                                   <!-- <label class="control-label">Fist Name</label>-->
													...
													<!--	<input type="hidden" class="form-control" name="valid_up_to_date[]" value="<?php echo date('Y-m-d', strtotime('+1 months'));?>" > -->
