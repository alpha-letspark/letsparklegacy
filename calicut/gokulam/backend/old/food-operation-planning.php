...
$result= mysql_query("SELECT * FROM topic where department='$department' and topic = 'OPERATIONAL PLANNING' "); 
...
if(isset($_POST['submit'] ))
{
  ...
  // $next_date=date('Y-m-d', strtotime('+1 months'));
    $sq = "SELECT * from rating WHERE date = '$currentDate' and user_id='$user_id' and topic = 'OPERATIONAL PLANNING' and department='FOOD AND BEVERAGE' "; 
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> <b>FOOD DEPARTMENT</b></a>
                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">FOOD DEPARTMENT (OPERATION PLANNING)
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
												...
												<select class="selectpicker" required name="rating[]" data-style="btn btn-primary btn-round" title="Single Select" data-size="7">
                                                    ...
                                                    <option value="0.50">Half way through</option>
