...
<?php if($_SESSION["id"]==1 ){ ?>
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">BD DEPARTMENT MIS REPORT </a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">BD Department Report</h4>
 ...
 $user_id =  $_SESSION['id'];
	...
	$query = sprintf("SELECT * FROM  rating  where department='BD' and user_id='$user_id' and date = '$date'");
//	echo $query;
...
?> 
					 ...
					 <?php 
	$user_id =  $_SESSION['id'];
	$query1 = sprintf("SELECT SUM(rating*actual_share*0.2) as total1 FROM  rating  where department='BD' and topic='team' and user_id='$user_id' and date = '$date' ");
	//echo $query1; 
		...
		//$total = $row['rating'] * $row['actual_share'];
		 ...
		 // echo $mark ;
		  ...
		  // echo "jaffar";
		  	...
		  	$query1 = sprintf("SELECT SUM(rating*actual_share*0.3) as total2 FROM  rating  where department='BD' and topic='OPERATIONAL PLANNING' and user_id='$user_id' and date = '$date' ");
	//echo $query1; 
	$qu1 =  mysql_query($query1) or die(mysql_error());
	while($row1 = mysql_fetch_array($qu1)){
		//extract($rowc); 
		//$total = $row['rating'] * $row['actual_share'];
		 ...
		 // echo $mark ;
		  ...
		  // echo "jaffar";
		  	...
		  	$query1 = sprintf("SELECT SUM(rating*actual_share*0.15) as total3 FROM  rating  where department='BD' and topic='FINANCIALS' and user_id='$user_id' and date = '$date' ");
	//echo $query1; 
	$qu1 =  mysql_query($query1) or die(mysql_error());
	while($row1 = mysql_fetch_array($qu1)){
		//extract($rowc); 
		//$total = $row['rating'] * $row['actual_share'];
		 ...
		 // echo $mark ;
		  ...
		  // echo "jaffar";
			...
			$query1 = sprintf("SELECT SUM(rating*actual_share*0.10) as total4 FROM  rating  where department='BD' and topic='TECHNOLOGY USAGE' and user_id='$user_id' and date = '$date' ");
	//echo $query1; 
	$qu1 =  mysql_query($query1) or die(mysql_error());
	while($row1 = mysql_fetch_array($qu1)){
		//extract($rowc); 
		//$total = $row['rating'] * $row['actual_share'];
		 ...
		 // echo $mark ;
		  ...
		  // echo "jaffar";  
		  	...
		  	$query1 = sprintf("SELECT SUM(rating*actual_share*0.25) total5 FROM  rating  where department='BD' and topic='BRAND IMAGE' and user_id='$user_id' and date = '$date' ");
	//echo $query1; 
	$qu1 =  mysql_query($query1) or die(mysql_error());
	while($row1 = mysql_fetch_array($qu1)){
		//extract($rowc); 
