            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">4W Under 15 Min</a>
                    </div>
...
$query = ("SELECT * from details_transaction where 
 DATE_FORMAT(entry_time,'%Y-%m-%d') = '$curdate'  and (TIME_TO_SEC(exit_time) - TIME_TO_SEC(entry_time)) <= 900 and  card_type = '4' ");
