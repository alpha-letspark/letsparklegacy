...
<body>
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Today's Detailed List</a>
                    </div>
                    ...
                    <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Today's Detailed List</h4>
    ...
    <form action="export.php" method="post" name="export_excel">
                 ...
                 <!--<button type="submit" id="export" name="export" class="btn btn-primary button-loading" data-loading-text="Loading...">Export to CSV/Excel File</button>-->
...
// $user_id =  $_SESSION['id'];
	...
	$query = ("SELECT transaction_id,redemption_id,vehicle_type,vehicle_number,entry_time, exit_time,amount, (TIME_TO_SEC(exit_time) - TIME_TO_SEC(entry_time)) AS duration, (CASE WHEN status = '1' THEN 'Completed' ELSE 'Running' END ) as status , (CASE WHEN area = '1' THEN 'Surface' ELSE 'Basement' END ) as area 
               FROM details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$curdate' and area = '0'");
