...
<?php if($_SESSION["id"]==4 ){ ?>
 ...
 <input id="gobutton" type="submit" value="submit" class="btn bg-teal-400" name="submit"  style="position: relative; background-color: #ff7900;right:-16px;" /> 
	...
	$q1 =  mysql_query("SELECT COUNT(id) as statu FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(entry_time,'%Y-%m-%d') <= '$date2'  and manual_vop_update = 1 and (card_type = '4' or card_type = '5')") or die(mysql_error());
//	echo $q1;
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="vop-detailed-report.php">
                                    <p class="category"><img src="icons/rupee.png" style="width:60px">Total Amt Collected</p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT SUM(amount) as sumnewrow FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(entry_time,'%Y-%m-%d') <= '$date2'  and manual_vop_update = 1") or die(mysql_error());
...
?>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="generate_vop_2w_list_view.php">
                                    <p class="category"><img src="icons/bike.png"  style="width:60px">No of Two Wheelers</p>
                                                                                                          <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec FROM details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(entry_time,'%Y-%m-%d') <= '$date2' and vehicle_type = '2'  and manual_vop_update = 1 and  card_type = '5'") or die(mysql_error());
...
?>
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="generate_vop_4w_list_view.php">
                                    <p class="category"><img src="icons/car.png"  style="width:60px">No of Four Wheelers </p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec FROM details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(entry_time,'%Y-%m-%d') <= '$date2' and vehicle_type = '4' and manual_vop_update = 1 and  card_type = '4'") or die(mysql_error());
