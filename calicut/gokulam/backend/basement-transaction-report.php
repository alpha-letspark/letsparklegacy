...
<?php if($_SESSION["id"]==4 ){ ?>
        ...
        <div class="main-panel">
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Today's Basement Transaction Report </a>
                    </div>
            ...
            <div class="content">
          <a href="vehicles-on-premises.php">   <button type="submit" name="submit" class="btn btn-rose btn-fill">Vehicles On Premises<div class="ripple-container"></div></button></a>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="basement-list-view.php">
                                    <p class="category"><img src="icons/transaction.png" style="width:60px"> Today's  Transaction</p>
                                    <?php 
...
<?php } ?>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="basement-list-view.php">
                                    <p class="category"><img src="icons/rupee.png" style="width:60px">Today's Amt Collected</p>
                                                                        <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT SUM(amount) as sumnewrow FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$curdate' and area = '1'") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="basement-list-view.php">
                                    <p class="category"><img src="icons/bike.png"  style="width:60px">No of Two Wheelers</p>
                                                                                                          <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec FROM details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$curdate' and vehicle_type = '2' and area = '1'") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="basement-list-view.php">
                                    <p class="category"><img src="icons/car.png"  style="width:60px">No of Four Wheelers </p>
                                                                        <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec FROM details_transaction where vehicle_type = '4' and DATE_FORMAT(entry_time,'%Y-%m-%d') = '$curdate' and area = '1'") or die(mysql_error());
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="basement-list-view.php">
                                    ...
                                    <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT count(*) FROM `details_transaction`  where vehicle_type = '2' and amount = '0' and DATE_FORMAT(entry_time,'%Y-%m-%d') = '$curdate' and status = '1' and area = '1' ") or die(mysql_error());
//  echo $q1;
  while($row2 = mysql_fetch_array($q1)){
?>
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="basement-list-view.php">
                                    <p class="category"><img src="icons/15mincar.png"  style="width:60px">4W Trans Under 15 mins</p>
                                                                        <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT count(*) FROM `details_transaction`  where vehicle_type = '4' and amount = '0' and DATE_FORMAT(entry_time,'%Y-%m-%d') = '$curdate' and area = '1' ") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="basement-list-view.php">
                                    <p class="category"><img src="icons/bike_money.png"  style="width:60px"> 2W Revenue Generation</p>
                                                                        <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT SUM(amount) as sum FROM `details_transaction`  where vehicle_type = '2' and DATE_FORMAT(entry_time,'%Y-%m-%d') = '$curdate' and area = '1' ") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="basement-list-view.php">
                                    <p class="category"><img src="icons/car_money.png"  style="width:60px">4W Revenue Generation </p>
                                                                        <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT SUM(amount) as sum FROM `details_transaction`  where vehicle_type = '4' and DATE_FORMAT(entry_time,'%Y-%m-%d') = '$curdate' and area = '1' ") or die(mysql_error()); 
