            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Vehicles on Premises </a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="vehicles-on-premises-list.php">
                                    <p class="category"><img src="icons/transaction.png" style="width:60px"> No of 2 Wheelers</p>
                                    <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT COUNT(transaction_id) as statu FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$curdate' and status = 0 and vehicle_type = 2") or die(mysql_error());
//  echo $q1;
...
<?php } ?>
                         ...
                         <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="vehicles-on-premises-list.php">
                                    <p class="category"><img src="icons/transaction.png" style="width:60px"> No of 4 Wheelers</p>
                                    <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT COUNT(transaction_id) as statu FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$curdate' and status = 0 and vehicle_type = 4") or die(mysql_error());
//  echo $q1;
  while($row2 = mysql_fetch_array($q1)){
?>
                                    <h3 class="card-title"><?php echo $row2['statu'];?></h3></a>
