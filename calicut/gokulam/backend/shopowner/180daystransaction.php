            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Last 6 Month Transaction Report </a>
                    </div>
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category"><img src="icons/car.png"  style="width:60px">No of Four Wheelers </p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec FROM details_transaction where vehicle_type = '2'  and DATE_FORMAT(entry_time,'%Y-%m-%d') > '$lastsevendays' and DATE_FORMAT(entry_time,'%Y-%m-%d') < '$curdate'") or die(mysql_error());
