...
<body>
        ...
        <div class="main-panel">
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> GENERATE REDEMPTION REPORT  </a>
                    </div>
            ...
            <div class="content">
                <div class="container-fluid">
					...
					<form name="form2" method="post" id="" action="redemption-post-new.php">
                        <div class="col-sm-4">
                            <div class="card">
 ...
 <input id="gobutton" type="submit" value="submit" class="btn bg-teal-400" name="submit"  style="position: relative;bottom: 4px; background-color: #ff7900;position: relative;
    right: -32px;" /> 
</form>
                    </div>
