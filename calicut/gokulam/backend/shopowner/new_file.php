...
$query = "INSERT INTO redemption_shopowner(client_id,card_number,shopowner_id,amount_redemmed,max_amount,redemption_flag,vehicle_type,created_at,extra) VALUES ('$client_id', '$card_number','$id', '$amount_redemmed','$max_amount','$redemption_flag','$vehicle_type', '$curdate' , '$transaction_id' )";
...
<div class="row">
					...
					<form name="form2" method="post" id="" action="new_file.php">
			           <div class="col-xs-3">
                            <div >
       <input type="text" style="height: 50px; margin-left:20px; " class="form-control" name="textfield2" placeholder="Card Number" required />
...
{ 
 ...
 $text = $_POST['textfield2'];
	 $result = mysql_query("SELECT * FROM details_transaction where card_number = '$text' and DATE_FORMAT(entry_time,'%Y-%m-%d') = '$curdate' and status = '0' and flag = '1' "); 
...
?> 
                                                ...
                                                <tr>
													...
													<td ><?php echo $row2['card_number'];?></td>
						...
						<input type="hidden" name="transaction_id" class="form-control"  value="<?php echo $row2['transaction_id'];?>" >
						 <input type="hidden" name="card_number" class="form-control"  value="<?php echo $row2['card_number'];?>" >
