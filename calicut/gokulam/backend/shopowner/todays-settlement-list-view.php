...
<body>
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Todays Settlement List</a>
                    </div>
                    ...
                    <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Todays Settlement Full Report</h4>
	...
	//$q1 =  mysql_query("SELECT redemption_id, shopowner_id , amount_redemmed, vehicle_type, redemption_flag,updated_at,created_at,updated_at
   // CASE
     //   WHEN redemption_flag= 0 THEN 'Settled'
     //   ELSE 'Not Settled'
  //  END AS result
//FROM
    //redemption_shopowner where DATE_FORMAT(updated_at,'%Y-%m-%d') =  '$curdate' and shopowner_id = $id ");
   ...
   ( CASE
    ...
    END ) AS result
FROM
    redemption_shopowner inner join details_transaction where details_transaction.redemption_id = redemption_shopowner.redemption_id  and DATE_FORMAT(redemption_shopowner.updated_at,'%Y-%m-%d') =  '$curdate' and redemption_shopowner.shopowner_id = $id and redemption_shopowner.redemption_flag= 0  ");
    while($row2 = mysql_fetch_array($q1)){                                                                                                    
