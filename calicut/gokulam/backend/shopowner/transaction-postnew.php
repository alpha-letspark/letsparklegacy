                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category"> <img src="icons/transaction.png" style="width:60px">Total Transaction</p>
                                    <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(transaction_id) as statu FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') > '$date1' and DATE_FORMAT(exit_time,'%Y-%m-%d') < '$date2' ") or die(mysql_error());
//	echo $q1;
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category"><img src="icons/rupee.png" style="width:60px">Total Amt Collected</p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT SUM(amount) as sumnewrow FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') > '$date1' and DATE_FORMAT(exit_time,'%Y-%m-%d') < '$date2'") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category"><img src="icons/bike.png"  style="width:60px">No of Two Wheelers</p>
                                                                                                          <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec FROM details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') > '$date1' and DATE_FORMAT(exit_time,'%Y-%m-%d') < '$date2'") or die(mysql_error());
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category"><img src="icons/15minbike.png"  style="width:60px"> 2W trans under 15 min </p>
                                    <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT count(*) FROM `details_transaction`  where vehicle_type = '2' and amount = '0' and status = '0' and DATE_FORMAT(entry_time,'%Y-%m-%d') > '$date1' and DATE_FORMAT(exit_time,'%Y-%m-%d') < '$date2' ") or die(mysql_error());
//	echo $q1;
	while($row2 = mysql_fetch_array($q1)){
?>
...
<?php } ?>
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category"><img src="icons/15mincar.png"  style="width:60px">4W trans under 15 min </p>
                                    <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT count(*) FROM `details_transaction`  where vehicle_type = '4' and amount = '0' and status = '0' and DATE_FORMAT(entry_time,'%Y-%m-%d') > '$date1' and DATE_FORMAT(exit_time,'%Y-%m-%d') < '$date2' ") or die(mysql_error());
//	echo $q1;
	while($row2 = mysql_fetch_array($q1)){
?>
                                    <h3 class="card-title"><?php echo $row2['count(*)'];?></h3>
...
<?php } ?>
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    ...
                                    <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT SUM(amount) as sum FROM `details_transaction`  where vehicle_type = '2' and DATE_FORMAT(entry_time,'%Y-%m-%d') > '$date1' and DATE_FORMAT(exit_time,'%Y-%m-%d') < '$date2' ") or die(mysql_error());
//	echo $q1;
	while($row2 = mysql_fetch_array($q1)){
?>
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category"><img src="icons/car_money.png"  style="width:60px">4W Revenue Generation</p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT SUM(amount) as sum FROM `details_transaction`  where vehicle_type = '4' and DATE_FORMAT(entry_time,'%Y-%m-%d') > '$date1' and DATE_FORMAT(exit_time,'%Y-%m-%d') < '$date2' ") or die(mysql_error());
...
?>
   ...
   $strQuery = "SELECT DISTINCT DATE_FORMAT(entry_time,'%Y-%m-%d') as date, sum(amount) as amount  from `details_transaction` where DATE_FORMAT(entry_time,'%Y-%m-%d') > '$date1' and DATE_FORMAT(entry_time,'%Y-%m-%d') < '$date2' group by DATE_FORMAT(entry_time,'%Y-%m-%d') ";
