...
<body>
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Generated Redemption Report Details </a>
                    </div>
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" style="width:100%">
                                            <thead>
                                                ...
                                                <tr align="center">
                                                    ...
                                                    <th align="center">Shopowner Id</th>
    ...
    END AS result
FROM
    redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') >=  '$date1' and DATE_FORMAT(created_at,'%Y-%m-%d') <='$date2' and shopowner_id= '$id'  ");
...
?> 
 ...
 $strQuery = "SELECT DISTINCT DATE_FORMAT(created_at,'%Y-%m-%d') as date, sum(amount_redemmed) as amount  from `redemption_shopowner` where DATE_FORMAT(created_at,'%Y-%m-%d')  >= '$d1' and DATE_FORMAT(created_at,'%Y-%m-%d')  <= '$d2  group by DATE_FORMAT(created_at,'%Y-%m-%d') where shopowner_id ='$id' ";
