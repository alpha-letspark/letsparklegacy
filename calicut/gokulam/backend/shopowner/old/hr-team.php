...
if(isset($_POST['submit'] ))
{
   ...
   $user_id =  $_SESSION['id'];
  // $next_date=date('Y-m-d', strtotime('+1 months'));men
    $sq = "SELECT * from rating WHERE date = '$currentDate' and user_id='$user_id' and topic = 'team' and department='HR'"; 
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">HR DEPARTMENT (TEAM)
