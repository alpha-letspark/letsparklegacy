            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">List  HR DEPARTMENT  </a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">List HR Department</h4>
...
// $user_id =  $_SESSION['id'];
	...
	$query = sprintf("SELECT * FROM  topic  where department='HR' ");
//	echo $query;
                                                ...
                                                <tr>
                                                  ...
                                                  <!-- <td><?php echo $rowc['topic'];?></td>-->
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        <a href="hr-edit.php?id=<?php echo $rowc['id'];?>" class="btn btn-success btn-simple"><i class="material-icons">edit</i></a>
                                                       <!-- <a href="#" class="btn btn-danger btn-simple"> <i class="material-icons">close</i></a>-->
