...
mysql_select_db("focusmall",$conn);
$result = mysql_query("SELECT * FROM login WHERE user='" . $_POST["user"] . "' and pass = '". (md5($_POST["pass"]))."'"); 
...
<head>
    ...
    <title>Lets Park Focus Mall</title>
                        ...
                        <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                            <form action="" method="post">
                                ...
                                <div class="card card-login card-hidden">
                                    <div class="card-header text-center" style="background-color:#dc124c">
									    <img class="card-title" src ="img/logo1.png">
            ...
            <footer class="footer">
                <div class="container">
                    ...
                    <p class="copyright pull-right">
                       ...
                       <a href="dashboard.html">Lets Park</a>, Lets Park 2018
                    </p>
                </div>
            </footer>
        </div>
