                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
									...
									<form name="form2" method="post" id="" action="hr-report.php">
...
?>
	...
	$query1 = sprintf("SELECT SUM(rating*actual_share) FROM  rating  where department='HR' ");
	//echo $query1;
	...
	while($row = mysql_fetch_array($qu)){
		...
		//$total = $row['rating'] * $row['actual_share'];
		 //echo SUM($total);
		  $mark=$row['SUM(rating*actual_share)'];
		  
		 // echo $mark ;
		  echo "<div style='text-align: center;font-weight:bold;'>Total Obtained ". $mark  ."</div>";
