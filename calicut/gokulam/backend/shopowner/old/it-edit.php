...
$sql="update topic set description='$_POST[description]',user_update_name='$_POST[user_update_name]',updated_at='$_POST[updated_at]' where id='$id' ";											
   ...
   if($result1)
   {
	...
	header('Location: it-list.php');
	 //header("Location: https://campusville.in/feedback/it-edit.php?department=IT");
     // echo "Successful";
//echo "<BR>";
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> <b>Edit IT DEPARTMENT</b></a>
                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Edit IT DEPARTMENT (TEAM)
