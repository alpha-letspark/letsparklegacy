...
$result= mysql_query("SELECT * FROM topic where department='$department' and topic = 'BRAND IMAGE' ");
...
if(isset($_POST['submit'] ))
{
  ...
  // $next_date=date('Y-m-d', strtotime('+1 months'));
    $sq = "SELECT * from rating WHERE date = '$currentDate' and user_id='$user_id' and topic = 'BRAND IMAGE' and department='BD'"; 
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> <b>BD DEPARTMENT</b></a>
                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">BD DEPARTMENT (BRAND IMAGE)
...
?>                    
									...
									<?php }?>
									<button type="submit" class="btn btn-rose pull-right" id="send"  onclick="this.style.display='none';" name="submit">Rate</button> 
									<?php } else {
