...
if(isset($_POST['submit'] ))
{
  ...
  // $next_date=date('Y-m-d', strtotime('+1 months'));
    $sq = "SELECT * from rating WHERE date = '$currentDate' and user_id='$user_id' and topic = 'BRAND IMAGE' and department='LEGAL'"; 
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">LEGAL DEPARTMENT (BRAND IMAGE)
