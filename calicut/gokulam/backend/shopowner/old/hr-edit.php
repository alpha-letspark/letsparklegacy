...
//$rec=mysql_result($result,0,"name");
...
//$id = mysql_real_escape_string(trim($_POST["id"])); 
   ...
   if($result1)
   {
	...
	header('Location: hr-list.php');
	 //header("Location: https://campusville.in/feedback/hr-edit.php?department=HR");
     // echo "Successful";
//echo "<BR>";
...
?>                    
									...
									<?php } else {
  //echo "You dont have previledge to access this page!";
