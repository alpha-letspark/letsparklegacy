...
//	 header("Location: https://campusville.in/feedback/accounts-edit.php?department=ACCOUNTS");
     // echo "Successful";
//echo "<BR>";
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> <b>Edit Accounts DEPARTMENT</b></a>
                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Edit Accounts DEPARTMENT
