...
//$id = mysql_real_escape_string(trim($_POST["id"]));
   ...
   if($result1)
   {
	...
	header('Location: legal-list.php');
	 //header("Location: https://campusville.in/feedback/legal-edit.php?department=LEGAL");
     // echo "Successful";
//echo "<BR>";
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> <b>Edit LEGAL DEPARTMENT</b></a>
                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Edit LEGAL DEPARTMENT (TEAM)
