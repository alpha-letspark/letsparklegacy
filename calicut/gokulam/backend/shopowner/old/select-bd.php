                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">BD Performence Report</h4>
                                    									<?php
									$queryreport = sprintf( "SELECT DISTINCT(date) as date from rating where department = 'BD'  ORDER BY id DESC LIMIT 3 ");
									...
									<form name="form2" method="post" id="" action="bd-report.php">
