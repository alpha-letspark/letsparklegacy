                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">IT Performence Report</h4>
                                    									<?php
									$queryreport = sprintf( "SELECT DISTINCT(date) as date from rating where department = 'IT' ORDER BY id DESC LIMIT 3 ");
									...
									<form name="form2" method="post" id="" action="admin-it-report.php">
