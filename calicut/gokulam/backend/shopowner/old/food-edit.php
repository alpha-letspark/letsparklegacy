...
//	 header("Location: https://campusville.in/feedback/food-edit.php?department=FOOD AND BEVERAGE");
     // echo "Successful";
//echo "<BR>";
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> <b>Edit FOOD AND BEVERAGE DEPARTMENT</b></a>
                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Edit FOOD AND BEVERAGE DEPARTMENT (TEAM)
