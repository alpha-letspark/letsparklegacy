        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
									...
									<form name="form2" method="post" id="" action="user-report.php">
                                      <b> FROM </b> <input onclick="ds_sh(this);"  class="form-control" name="date1" type="text" readonly="readonly" placeholder="Start Date...." required/> 
                                   <b>TO</b> <input name="date2" onclick="ds_sh(this);" class="form-control"type="text" readonly="readonly"  placeholder="End Date.." required/>
                  ...
                  <select name="rated_by" id="meetingPlace" class="form-control" style="color:black;">
						               <option value="" disabled selected hidden>Select Users</option>
									   
						                 <?php     
                                                     $sq = "SELECT DISTINCT(rated_by)  FROM rating order by rated_by asc";
                                                     $rs = mysql_query($sq);
                                                    while($row = mysql_fetch_array($rs))
                                                  {
                                                      echo "<option value=\"".$row['rated_by']."\">".$row['rated_by']."\n ";
                                                  }
                                               ?>
						            </select>
...
$two=$_REQUEST['date2'];
	...
	$rated_by=$_POST["rated_by"]; 
	 ...
	 $results = mysql_query("SELECT * FROM rating where date between '$one' and '$two' and department='".$des."' and rated_by='".$rated_by."' ");
