...
<body>
	...
	$q1 =  mysql_query("SELECT details_transaction.vehicle_number,redemption_shopowner.extra, redemption_shopowner.shopowner_id , redemption_shopowner.amount_redemmed, redemption_shopowner.vehicle_type, redemption_shopowner.redemption_flag,redemption_shopowner.updated_at,redemption_shopowner.created_at,
    (CASE
        WHEN redemption_shopowner.redemption_flag= 0 THEN 'Settled'
        ELSE 'Not Settled'
    END) AS result
FROM
    redemption_shopowner inner join details_transaction where details_transaction.transaction_id = redemption_shopowner.extra  and redemption_shopowner.shopowner_id ='$id' and  DATE_FORMAT(redemption_shopowner.created_at,'%Y-%m-%d') >=  '$curdate' ");
...
?> 
                                                ...
                                                <tr>
													...
													<td align="center"><?php echo $row2['extra'];?></td>
