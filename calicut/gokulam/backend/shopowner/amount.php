        ...
        <div class="main-panel">
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Add Amount/Recharge </a>
                    </div>
            ...
            <div class="content">
                <div class="container-fluid">
                            ...
                            <div class="card">
                                ...
                                <form id="RegisterValidation" action="" method="post" >
                                    ...
                                    <div class="card-content">
                                        <h4 class="card-title"><b>&nbsp;Add Amount/Recharge</b></h4>
					...
					<select name="name" id="meetingPlace" class="form-control" style="color:black;">
						               <option value="" disabled selected hidden>Select Employee</option>
									   
						                 <?php     
                                                     $sq = "SELECT * from employee_list";
                                                     $rs = mysql_query($sq);
                                         ...
                                         <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" id="employee_id" name="employee_id"  type="text"  autocomplete="off">
                                        </div>
										 <div class="form-group label-floating">
                                              &nbsp;&nbsp;Amount
                                             <label class="control-label">
										 ...
										 &nbsp;&nbsp;Valid From
                                            ...
                                            <input class="form-control" name="valid_from" id="valid_from" type="date" required="" autocomplete="off">
                                        </div>
										 <div class="form-group label-floating">
										  &nbsp;&nbsp;Valid To
											<label class="control-label">
                                            ...
                                            <input class="form-control" name="valid_to" id="valid_from" type="date" required="" autocomplete="off">
                                        </div>

                                        <div class="form-footer text-right">
                                            
                                            <input type="submit" name="submit" class="btn btn-rose btn-fill"></submit>
                                        </div>
                                    </div>
                                </form>
...
// $user_id =  $_SESSION['id'];
	...
	$query = sprintf("SELECT * FROM  employee_pass ORDER BY  name ASC");
//	echo $query;
