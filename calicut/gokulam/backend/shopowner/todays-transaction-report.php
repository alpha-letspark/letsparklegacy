                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category"><img src="icons/bike_money.png"  style="width:60px"> 2W Revenue Generation</p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT SUM(amount) as sum FROM `details_transaction`  where vehicle_type = '2' and DATE_FORMAT(entry_time,'%Y-%m-%d') = '$curdate' ") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category"><img src="icons/car_money.png"  style="width:60px">4W Revenue Generation </p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT SUM(amount) as sum FROM `details_transaction`  where vehicle_type = '4' and DATE_FORMAT(entry_time,'%Y-%m-%d') = '$curdate' ") or die(mysql_error());
