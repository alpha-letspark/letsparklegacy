                ...
                <div class="container-fluid">
					...
					<form name="form2" method="post" id="" action="generate.php">
                        ...
                        <div class="col-xs-2">
                            <div class="card">
                                <div class="card-content text-center">
                                    <code> <b> Time FROM </b> <input class="form-control" name= "time1" type="time"/></code>
                                </div>
                            </div>
                        </div>
						<div class="col-xs-2">
                            <div class="card">
                                <div class="card-content text-center">
                                    <code> <b> Time To </b> <input class="form-control" name= "time2" type="time"/></code>
                                </div>
                            </div>
                        </div>
						<div class="col-xs-2">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Redemption Report</h4>
