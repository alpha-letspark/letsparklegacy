...
<body>
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Settlement Report Details </a>
                    </div>
                    ...
                    <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a href="settledreport.php"> <input id="gobutton" type="submit" value="Go Back" class="btn bg-teal-400" name="submit" style=" background-color: #ff7900;position: relative;"></a>
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" style="width:100%">
                                            <thead>
                                                ...
                                                <tr align="center">
													...
													<th align="center">Settled Date & Time</th>
	...
	$query = ("SELECT 
    redemption_id, shopowner_id,login.user as shop, amount_redemmed, vehicle_type, redemption_flag,created_at,
    CASE
        WHEN redemption_flag= 0 THEN 'Settled'
        ELSE NULL
    END AS result
FROM
    redemption_shopowner inner join login where redemption_shopowner.shopowner_id = login.id and  DATE_FORMAT(updated_at,'%Y-%m-%d')='$curdate' and redemption_flag= '0'");
