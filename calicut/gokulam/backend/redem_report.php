...
<body>
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Redemption Report Details </a>
                    </div>
                    ...
                    <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Redemption Full Report</h4>
	...
	$query = "SELECT 
    details_transaction.vehicle_number,redemption_shopowner.redemption_id, redemption_shopowner.shopowner_id , redemption_shopowner.amount_redemmed, redemption_shopowner.vehicle_type, redemption_shopowner.redemption_flag,redemption_shopowner.updated_at,redemption_shopowner.created_at,
   ( CASE
        WHEN redemption_shopowner.redemption_flag= 0 THEN 'Settled'
        ELSE 'Not Settled'
    END ) AS result
FROM
    redemption_shopowner inner join details_transaction where details_transaction.redemption_id = redemption_shopowner.redemption_id and redemption_shopowner.shopowner_id ='$id' and  DATE_FORMAT(redemption_shopowner.created_at,'%Y-%m-%d') >=  '$date1' and DATE_FORMAT(redemption_shopowner.created_at,'%Y-%m-%d') <= '$date2'";
...
?> 
                                                ...
                                                <tr>
                                                    <td align="center"><?php echo $rowc['redemption_id'];?></td>
													<td align="center"><?php echo $rowc['amount_redemmed'];?></td>
													<td align="center"><?php echo $rowc['vehicle_type'];?></td>
                                                    <td align="center"><?php echo $rowc['vehicle_number'];?></td>
													<!--<td align="center"><?php echo $rowc['result'];?></td>-->
													<td align="center"><?php echo $rowc['created_at'];?></td>
                                                    <td align="center"><?php echo $rowc['updated_at'];?></td>
 ...
 $strQuery = "SELECT DISTINCT DATE_FORMAT(created_at,'%Y-%m-%d') as date, sum(amount_redemmed) as amount  from `redemption_shopowner` where DATE_FORMAT(created_at,'%Y-%m-%d') = '2018-10-08' group by DATE_FORMAT(created_at,'%Y-%m-%d') ";
