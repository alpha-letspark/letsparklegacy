...
$sql="select * from recharge_details" or die(mysql_error());
...
<a href="employee-card-recharge.php"> <input id="gobutton" value="Recharge" class="btn bg-teal-400" name="submit" style="background-color: #ff7900;position: relative;border: 2px solid #ff7900;color: #ffffff;"></a>
...
<?php
$query = sprintf("SELECT valid_from, valid_to from employee_allocation where card_number = '$card_number' ORDER BY id DESC
LIMIT 1 ");
$qur =  mysql_query($query) or die(mysql_error());
    while($rowc = mysql_fetch_array($qur)){
     $valid_from = $rowc['valid_from'];
     $valid_to = $rowc['valid_to'];
     echo "<p><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Previous Validity details</b></p>";
     echo "<p><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Valid From: </b>" .$valid_from."</p>";

    echo "<p><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Valid To: </b>" .$valid_to."</p>";
         echo "<hr />"; 


 }
 ?>
<!-- Check Previous Validity ends here -->

                                    <div class="card-content">
                                        <h4 class="card-title"><b>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;Recharge Card:</b></h4>
                                        <div class="row">
  <div class="col-md-4"> <div class="" style="    position: relative;
    right: -48px;
    top: 20px;">
                                             Amount:
                                            <input class="" id="amount" name="amount"  type="text"  autocomplete="off" required="">
                                            <input class="" id="employee_id" name="employee_id"  type="hidden" value="<?php echo $row2['emp_id'];?>" autocomplete="off">
                                            <input class="" id="vehicle_type" name="vehicle_type"  type="hidden" value="<?php echo $row2['vehicle_type'];?>" autocomplete="off">
                                            <input class="" id="vehicle_number" name="vehicle_number"  type="hidden" value="<?php echo $row2['vehicle_number'];?>" autocomplete="off">
                                             <input class="" id="card_number" name="card_number"  type="hidden" value="<?php echo $card_number;?>" autocomplete="off">
                                        </div></div>
  <div class="col-md-4">          <div class="form-group label-floating">
 Valid From:<input class="" id="valid_from" name="valid_from"  type="date"  autocomplete="off" required="">
                                        </div></div>
  <div class="col-md-4"> <div class="form-group label-floating">Valid To:
                                            </label>
                                            <input class="" id="valid_to" name="valid_to"  type="date"  autocomplete="off" required="">
                                        </div></div>
</div>
 
                                         <input type="submit" name="submit" class="btn btn-rose btn-fill" style="align:center;position: relative;right:-180px;"></submit>
                                         <br />
                                         <br />
                                        <hr/>
                                    </div>
