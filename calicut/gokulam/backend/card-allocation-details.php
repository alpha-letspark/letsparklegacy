...
<a href="card-allocation.php"> <input id="gobutton"  value="History" class="btn bg-teal-400" name="submit" style=" background-color: #ff7900;position: relative;"></a><br />
<a href="card-allocation.php"> <input id="gobutton"  value="Overall" class="btn bg-teal-400" name="submit" style=" background-color: #007C84;position: relative;width: 110px;height: 29px;"></a>
<a href="recharge-history.php"> <input id="gobutton"  value="Card No" class="btn bg-teal-400" name="submit" style=" background-color: #007C84;position: relative;width: 150px;height: 29px;"></a>
</div>

                                    <h4 class="card-title">Card Allocation Report</h4>
...
END AS type, employee_allocation.card_number,employee_allocation.employee_name,employee_allocation.shop_id,employee_allocation.valid_from,employee_allocation.valid_to,login.name as name, employee_allocation.current_status as current_status, CASE
        ...
        ELSE 'ALLOCATED'
END AS result from employee_allocation inner join login where employee_allocation.shop_id=login.id  and employee_allocation.valid_to >= '$date1' and employee_allocation.valid_to <= '$date2'");
