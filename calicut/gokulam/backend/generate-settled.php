...
<body>
    ...
    -->
        ...
        <div class="main-panel">
          ...
          <form name="form2" method="post" id="" action="generate-settled-report.php">
                 <div class="col-xs-3">
                            <div class="card">
       <input type="text" name="shopowner_id" id="search-box" value="<?php echo $shopowner["id"];?>" placeholder="Select Shopowner" autocomplete ="off" />
                    ...
                    <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><b>Shopowner Settlement Details Overview</b></h4>
                                    ...
                                    <div class="material-datatables">
                                        ...
                                        <table align="center" id="datatables" class="table table-striped table-no-bordered table-hover" style="width:100%">
                                            <thead>
                                                ...
                                                <tr>
                                                    <th><b>Shop Name</b></th>
                                                    <th><b>Todays Settlement</b></th>
                                                    <th><b>Todays Amount Settled</b></th>
                               ...
                               <div class="material-datatables">
                                        ...
                                        <table align="center" id="datatables" class="table table-striped table-no-bordered table-hover" style="width:100%">
                                            <thead>
                                                ...
                                                <tr>
                                                    <th><b>Shop Name</b></th>
                                                    <th><b>Total Settlement</b></th>
                                                    <th><b>Total Amount Settled</b></th>
...
// $user_id =  $_SESSION['id'];
            $curdate=  date('Y-m-d');
    $query = ("SELECT redemption_shopowner.shopowner_id,login.name as name, sum(redemption_shopowner.amount_redemmed) as total_amount, count(redemption_shopowner.id) as total  FROM `redemption_shopowner` inner JOIN login where redemption_shopowner.shopowner_id = login.id and redemption_flag='0' group by redemption_shopowner.shopowner_id");
