...
<?php if($_SESSION["id"]==4 ){ ?>
        ...
        <div class="main-panel">
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Yesterday's VoP Report </a>
                    </div>
            ...
            <div class="content">
                <div class="container-fluid" >
<a href="generate-vop.php"> <input id="gobutton" type="submit" value="Generate VOP" class="btn bg-teal-400" name="submit" style=" background-color: #ff7900;position: relative; "></a> <br/>                       
				<div align="center">	<b >Date :</b> <?php echo $yesterday ?></div>
...
<div class="row">
 ...
 <input id="gobutton" type="submit" value="submit" class="btn bg-teal-400" name="submit"  style="position: relative; background-color: #ff7900;right:-16px;" /> 
       ...
       <!--<div align="left"> <a href="generate-vop.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="gobutton" type="submit" value="Generate Report" class="btn bg-teal-400" name="submit" style=" background-color: #ff7900;"></a><a href="generate-vop.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a><a href="generate-vop.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="gobutton" type="submit" value="Export to Excel" class="btn bg-teal-400" name="submit" style=" background-color: #ff7900;"></a></div>-->
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="vop-yesterdays-report.php">
                                    <p class="category"> <img src="icons/transaction.png" style="width:60px">Total VOP</p>
                                    <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(transaction_id) as statu FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday' and (card_type = '4' or card_type = '5'  or card_type = '6') and manual_vop_update = 1") or die(mysql_error());
//	echo $q1;
...
<?php } ?>
                      ...
                      <!--  <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="vop-detailed-report.php">
                                    <p class="category"><img src="icons/rupee.png" style="width:60px">Total Amt Collected</p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT SUM(amount) as sumnewrow FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday'  and status = '0'") or die(mysql_error());
...
?>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="yesterdays_vop_2w_list_view.php">
                                    <p class="category"><img src="icons/bike.png"  style="width:60px">No of Two Wheelers</p>
                                                                                                          <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec FROM details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday' and vehicle_type = '2' and manual_vop_update = 1  and card_type = '5'") or die(mysql_error());
...
?>
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="yesterdays_vop_4w_list_view.php">
                                    <p class="category"><img src="icons/car.png"  style="width:60px">No of Four Wheelers </p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec FROM details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday'  and vehicle_type = '4'  and manual_vop_update = 1  and (card_type = '4' or card_type = '6' ") or die(mysql_error());
