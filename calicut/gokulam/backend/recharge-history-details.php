...
// $user_id =  $_SESSION['id'];
    ...
    $query = sprintf("SELECT recharge_details.card_number, recharge_details.amount,recharge_details.valid_from,recharge_details.valid_to,recharge_details.recharge_date,employee_allocation.vehicle_number,employee_allocation.vehicle_type,employee_allocation.employee_name from recharge_details inner join employee_allocation where employee_allocation.card_number=recharge_details.card_number and employee_allocation.card_number = '$card_number'");
//  echo $query;
