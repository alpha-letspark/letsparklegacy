        ...
        <div class="main-panel">
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> GENERATE VOP REPORT  </a>
                    </div>
            ...
            <div class="content">
                <div class="container-fluid">
	                ...
	                <div class="row">
					<form name="form2" method="post" id="" action="vop-postnew.php">
                        <div class="col-sm-4">
                            <div class="card">
                                <div class="card-content text-center">
                                    <code> <b> Date FROM </b> <input onclick="ds_sh(this);" value="<?php echo $current_date; ?>" class="form-control" name="date1" type="text" readonly="readonly" required/> </code>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="card">
                                <div class="card-content text-center">
                                    <code> <b>Date TO</b> <input name="date2" onclick="ds_sh(this);" value="<?php echo $current_date; ?>" class="form-control"type="text" readonly="readonly"  required/></code>
                                </div>
                            </div>
                        </div>
                       <!-- <div class="col-xs-2">
