            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Today's Redeemption Report </a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="todays-redem-list-view.php">
                                    <p class="category"><img src="icons/redemption.png"  style="width:60px"> Today's Redeemption</p>
                                    <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(extra) as statu FROM  redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') = '$curdate' ") or die(mysql_error());
//	echo $q1;
...
<?php } ?>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="todays-redem-list-view.php">
                                    <p class="category"><img src="icons/redemrupee.png"  style="width:60px">Today's Amt Redeemed</p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT SUM(amount_redemmed) as sumnewrow FROM  redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') =  '$curdate'") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="todays-redem-list-view.php">
                                    <p class="category"><img src="icons/redemptionbike.png"  style="width:60px">No of Two Wheelers</p>
                                                                                                          <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec FROM redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') = '$curdate' and vehicle_type = '2'") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="todays-redem-list-view.php">
                                    <p class="category"><img src="icons/redemptioncar.png"  style="width:60px">No of Four Wheelers </p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec FROM redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') = '$curdate' and vehicle_type = '4'") or die(mysql_error());
				...
				<div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="todays-redem-list-view.php">
                                    <p class="category"> <img src="icons/redemptionbike.png" style="width:60px">Amount Redeemed 2W</p>
                                    <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT SUM(amount_redemmed) as sumnewrow FROM  redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') = '$curdate' and vehicle_type='2'") or die(mysql_error());
//	echo $q1;
	while($row2 = mysql_fetch_array($q1)){
?>
...
<?php } ?>
                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="todays-redem-list-view.php">
                                  <p class="category"><img src="icons/redemptioncar.png" style="width:60px"> Amount Redeemed 4W</p></p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT SUM(amount_redemmed) as sumnewrow FROM  redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') = '$curdate' and vehicle_type='4'") or die(mysql_error());
