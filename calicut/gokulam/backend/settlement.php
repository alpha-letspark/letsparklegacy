        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
					...
					<form name="form2" method="post" id="" action="redemption-post.php">
			           <div class="col-xs-3">
                            <div class="card">
                                <div class="card-content text-center">
                       <code> <b> Select Shopowner </b> <select name="department" class="form-control" >
			           <option value=""> SELECT SHOPOWNER</option> 
                       <option value="HR">SHOPPER STOP</option>
                       <option value="IT">TITAN</option>
