            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">VoP Generated Detailed List</a>
                    </div>
                    ...
                    <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">VoP Generate Detailed List</h4>
...
// $user_id =  $_SESSION['id'];
	...
	$query = ("SELECT transaction_id,redemption_id,card_number,vehicle_type,vehicle_number,entry_time, exit_time, (TIME_TO_SEC(exit_time) - TIME_TO_SEC(entry_time)) AS duration, (CASE WHEN status = '1' THEN 'Completed' ELSE 'Running' END ) as status 
               FROM details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(entry_time,'%Y-%m-%d') <= '$date2' and status='0'");
