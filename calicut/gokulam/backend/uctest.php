...
<?php
 ...
 ?>
    ...
    <?php
       ...
       $q2 =  mysql_query("SELECT count(*) as four_wheeler_count from details_transaction where  exit_user_id = $uid and exit_time >= '$date_from' and exit_time <= '$date_to' and area = '0' and vehicle_type = 4") or die(mysql_error());
      $rowc1 = mysql_fetch_array($q2);
