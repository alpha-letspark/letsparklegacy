...
<?php if($_SESSION["id"]==4 ){ ?>
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                	<div class="toolbar">  <div class="dropdown pull-right">
													<select class="selectpicker" data-style="btn btn-primary btn-round" title="Single Select" data-size="7" onChange="window.location.href=this.value">
                                                        ...
                                                        <option value="yesterdayredemption.php">Yesterday</a>
                                                        <option value="7daysredemption.php">Last 7 days </a>
                                                        <option value="30daysredemption.php">Last Month
                                                        <option value="90daysredemption.php">Last 3 Month
                                                        <option value="180daysredemption.php">Last 6 Month
                                                        <option value="365daysredemption.php">Last 1 year
                                                        <option value="alldaysredemption.php">All
										   </select>
										   </div></div>

                    <div class="row">
						                <div class="row">
<div align="left"> <a href="redemption_report.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="gobutton" type="submit" value="Generate Report" class="btn bg-teal-400" name="submit" style=" background-color: #ff7900;"></a><a href="/generate-redemption.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a><a href="/generate-redemption.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="gobutton" type="submit" value="Export to Excel" class="btn bg-teal-400" name="submit" style=" background-color: #ff7900;"></a></div>
	   ...
	   <div align="center"> <b>From Date :</b> <?php echo $date1 ?><b>&nbsp;&nbsp;To Date : </b><?php echo $date2 ?></div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="redemption_report.php">
                                    <p class="category"><img src="icons/redemption.png"  style="width:60px"> Total Redeemption</p>
                                    <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(redemption_id) as statu FROM  redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(created_at,'%Y-%m-%d') <= '$date2'") or die(mysql_error());
//	echo $q1;
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="redemption_report.php">
                                    <p class="category"><img src="icons/redemrupee.png"  style="width:60px">Total Amt Collected</p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT SUM(amount_redemmed) as sumnewrow FROM  redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(created_at,'%Y-%m-%d') <= '$date2'") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="redemption_report.php">
                                    <p class="category"><img src="icons/redemptionbike.png"  style="width:60px">No of Two Wheelers</p>
                                                                                                          <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec FROM redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(created_at,'%Y-%m-%d') <= '$date2' and vehicle_type='2'") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="redemption_report.php">
                                    <p class="category"><img src="icons/redemptioncar.png"  style="width:60px">No of Four Wheelers </p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec FROM redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(created_at,'%Y-%m-%d') <= '$date2' and vehicle_type='4'") or die(mysql_error());
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="redemption_report.php">
                                    <p class="category"><img src="icons/15minbike.png"  style="width:60px"> Amt Redeemed from 2W</p>
                                    <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT SUM(amount_redemmed) as sumnewrow FROM  redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(created_at,'%Y-%m-%d') <= '$date2' and vehicle_type='2'") or die(mysql_error());
//	echo $q1;
	while($row2 = mysql_fetch_array($q1)){
?>
                                    <h3 class="card-title">₹<?php echo $row2['sumnewrow'];?></h3></a>
...
<?php } ?>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="redemption_report.php">
                                    <p class="category"><img src="icons/15mincar.png"  style="width:60px">Amt Redeemed from 4W</p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT SUM(amount_redemmed) as sumnewrow FROM  redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(created_at,'%Y-%m-%d') <= '$date2' and vehicle_type= '4' ") or die(mysql_error());
