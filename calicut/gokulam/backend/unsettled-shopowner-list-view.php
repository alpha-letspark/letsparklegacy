...
<body>
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Unsettled Report Details </a>
                    </div>
                    ...
                    <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Unsettled  Report</h4>
    ...
    END AS result
FROM
    redemption_shopowner inner join login where redemption_shopowner.shopowner_id = login.id and DATE_FORMAT(created_at,'%Y-%m-%d') >= '$date1' and DATE_FORMAT(created_at,'%Y-%m-%d') <= '$date2'  and redemption_flag= '1'");
