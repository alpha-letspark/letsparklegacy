                    ...
                    <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Redeemption Detailed List</h4>
									
                                    <div class="toolbar">
                                        <!--        Here you can write extra buttons/actions for the toolbar              -->
                                       <a href="todays-redemption-report.php"> <input id="gobutton" type="submit" value="Go Back" class="btn bg-teal-400" name="submit" style=" background-color: #ff7900;position: relative;"></a>
                                    </div>
...
FROM
    redemption_shopowner inner join login where redemption_shopowner.shopowner_id = login.id and DATE_FORMAT(created_at,'%Y-%m-%d') = '$curdate'");
