...
<a href="card-allocation.php"> <input id="gobutton"  value="History" class="btn bg-teal-400" name="submit" style="background-color: #ff7900;position: relative;border: 2px solid #ff7900;color: #ffffff;width:150px"></a>
 <a href="employee_list.php"> <input id="gobutton"  value=" Employee List" class="btn bg-teal-400" name="submit"style="background-color: #ffffff;position: relative;border: 2px solid #ff7900;color: #ff7900;width: 160px;"></a>
 <a href="card-allocation.php"><br /><input id="gobutton"  value="Overall" class="btn bg-teal-400" name="submit" style=" background-color: #fff;position: relative;width: 150px;height: 29px;color:#007C84;border: 2px solid #007C84;"></a>
<a href="recharge-history.php"> <input id="gobutton"  value="Card Number" class="btn bg-teal-400" name="submit" style=" background-color: #007C84;position: relative;width: 155px;height: 29px;border: 2px solid #007C84;"></a>
</div>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
          ...
          <form name="form2" method="post" id="" action="recharge-history-details.php">
                 <div class="col-xs-3">
                            <div class="card">
  <input type="text" name="card_number" id="search-box" value="<?php echo $card["card_number"];?>" placeholder="Enter Card Number" autocomplete ="off" required/>
 ...
 <input id="gobutton" type="submit" value="submit" class="btn bg-teal-400" name="submit"  style="position: relative;
    right: -20px;top: 16px; background-color: #ff7900;" /> 
</form>
                    </div>
...
{ 
   ...
   $results = mysql_query("select login.name as shopname,employee_allocation.id as id, employee_allocation.employee_name as employee_name,employee_allocation.mobile as mobile, employee_allocation.vehicle_type as vehicle_type, employee_allocation.vehicle_number as vehicle_number,employee_allocation.card_type as card_type from employee_allocation inner join login where employee_allocation.shop_id = login.id and employee_allocation.current_status = '0' ");
...
if(mysql_num_rows($results) >= 1)
{
  ...
  ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $rowc1['shopname'];?></td>
                                                     <td><?php echo $rowc1['mobile'];?></td>
