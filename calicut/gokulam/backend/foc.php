...
<?php if($_SESSION["id"]==4 ){ ?>
        ...
        <div class="main-panel">
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">FOC Report </a>
                    </div>
            ...
            <div class="content">
                <div class="container-fluid">
<a href="generate-foc.php"> <input id="gobutton" type="submit" value="Generate FOC" class="btn bg-teal-400" name="submit" style=" background-color: #ff7900;position: relative; "></a>
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="yesterday-FOC.php">
                                    <p class="category"><img src="icons/redemption.png"  style="width:55px"> Yesterday's FOC</p>
                                    <?php 
    //$dept=$_POST['department'];
    $q1 =  mysql_query("SELECT COUNT(foc) as statu FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday' and foc = '1' ") or die(mysql_error());
//  echo $q1;
