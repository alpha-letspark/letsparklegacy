                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="unsettled_redemption_report.php">
                                    <p class="category"><img src="icons/redemption.png"  style="width:60px"> Unsettled Transaction</p>
                                    <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(redemption_id) as statu FROM  redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') = '$curdate' 
 and redemption_flag='1'") or die(mysql_error());
//	echo $q1;
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="unsettled_redemption_report.php">
                                    <p class="category"><img src="icons/redemrupee.png"  style="width:55px">Total Amt Unsettled</p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT SUM(amount_redemmed) as sumnewrow FROM  redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') =  '$curdate' and redemption_flag='1'") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="unsettled_redemption_report.php">
                                    <p class="category"><img src="icons/redemptionbike.png"  style="width:60px">No of Unsettled 2W</p>
                                                                                                          <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT count(redemption_id) as vec FROM redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') = '$curdate' and vehicle_type = '2' and redemption_flag='1'") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="unsettled_redemption_report.php">
                                    <p class="category"><img src="icons/redemptioncar.png"  style="width:60px">No of Unsettled 4W </p>
                                                                        <?php 
	//$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT count(redemption_id) as vec FROM redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') = '$curdate' and vehicle_type = '4' and redemption_flag='1'") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="unsettled_redemption_report.php">
                                    <p class="category"><img src="icons/redemptionbike.png"  style="width:60px">Amt Unsettled from 2W </p>
                                                                        <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT SUM(amount_redemmed) as sumnewrow FROM  redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') =  '$curdate' and redemption_flag='1' and vehicle_type='2'") or die(mysql_error());
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="unsettled_redemption_report.php">
                                    <p class="category"><img src="icons/redemptioncar.png"  style="width:60px">Amt Unsettled from 4W </p>
                                                                        <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT SUM(amount_redemmed) as sumnewrow FROM  redemption_shopowner where DATE_FORMAT(created_at,'%Y-%m-%d') =  '$curdate' and redemption_flag='1' and vehicle_type='4'") or die(mysql_error());
