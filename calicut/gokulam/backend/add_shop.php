                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <form action="shop_codes.php" method="post">
                                    ...
                                    <div class="card-content" >
                                        <!--<h4 class="card-title"><b>Request Parking Cards</b></h4>-->
                                         <h4 class="card-title"> <?php if(isset($success)) { ?> <div class="alert alert-success"><i class="fa fa-check fa-fw"></i> Successfully Created </div> <?php } ?></h4>
                                           <div class="form-group label-floating">
											...
											<input class="form-control" name="name" type="text" value="<?php echo $name; ?>" required autocomplete="off">
                                        </div>
                                         <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" name="username" type="text" value="<?php echo $user; ?>" required autocomplete="off">
                                        </div> 
										<div class="form-group label-floating">
											 ...
											 <label class="control-label">
                                              New Password
                                               <small>*</small>
												...
												<input class="form-control" name="password" id="password" disabled="" type="text" required autocomplete="off" ></input>
											...
											<input class="form-control" name="password" type="text" required autocomplete="off"></input>
											<?php endif ?>
                                        ...
                                        <div class="form-footer text-right">
											...
											<?php else: ?>
											<button type="submit" name="add_attendant" class="btn btn-rose btn-fill">Submit</button>
											<?php endif ?>
