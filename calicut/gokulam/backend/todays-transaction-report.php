...
<?php if($_SESSION["id"]==4 ){ ?>
  ...
  $q1 =  mysql_query("SELECT COUNT(transaction_id) as statu FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday' and (card_type = '4' or card_type = '5') ") or die(mysql_error());
//  echo $q1;
...
<?php } ?>
                         ...
                         <p class="category"><img src="icons/transaction.png" style="width:60px"> Exit</p>
                                    <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT COUNT(transaction_id) as statu FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday' and status = '1' and (card_type = '4' or card_type = '5')") or die(mysql_error());
//  echo $q1;
  while($row2 = mysql_fetch_array($q1)){
?>
                                    <h3 class="card-title"><?php echo $row2['statu'];?></h3></a>
...
<?php } ?>
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
                         ...
                         <p class="category"><img src="icons/transaction.png" style="width:60px"> Overnight Parking</p>
                                    <?php 
  //$dept=$_POST['department'];
	$q1 =  mysql_query("SELECT COUNT(id) as statu FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday'  and(card_type = '4' or card_type = '5') and status = 0 ") or die(mysql_error());
//  echo $q1;
  while($row2 = mysql_fetch_array($q1)){
?>
                                    <h3 class="card-title"><?php echo $row2['statu'];?></h3></a>
...
<?php } ?>
                    ...
                    <div class="card-content"><a href= "list-view-transaction.php"><a href="dashboard-trans-yesterdays-list-view.php">
                                    <p class="category"><img src="icons/rupee.png" style="width:60px">Amt Collected</p>
                                                                        <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT SUM(amount) as sumnewrow FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday' and (card_type = '4' or card_type = '5')") or die(mysql_error());
...
?>
                       ...
                       <div class="card-content"><a href= "list-view-transaction.php"><a href="dashboard-trans-yesterdays-list-view-two.php">
                                    <p class="category"><img src="icons/bike.png"  style="width:60px">2 Wheeler Entry</p>
                                                                                                          <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec FROM details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday' and vehicle_type = '2' and (card_type = '4' or card_type = '5')") or die(mysql_error());
 ...
 <div class="col-lg-3 col-md-6 col-sm-6">
                       ...
                       <div class="card-content"><a href= "list-view-transaction.php"><a href="dashboard-trans-yesterdays-list-view_2w_Exit.php">
                                    <p class="category"><img src="icons/bike.png"  style="width:60px">2 Wheeler Exit</p>
                                                                                                          <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec FROM details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday' and vehicle_type = '2' and status = '1' and (card_type = '4' or card_type = '5')") or die(mysql_error());
...
<div class="col-lg-3 col-md-6 col-sm-6">
                       ...
                       <div class="card-content"><a href="2w-on-premises_yesterday.php">
                                    <p class="category"><img src="icons/transaction.png"  style="width:60px">'Overnight 2W</p>
<?php
$q1 =  mysql_query("SELECT COUNT(transaction_id) as statu FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday' and vehicle_type = '2' AND  manual_vop_update = 1 and card_type = '5' ") or die(mysql_error());
...
<div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="dashboard-trans-yesterdays-list-view-two.php">
                                    ...
                                    <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT SUM(amount) as sum FROM `details_transaction`  where vehicle_type = '2' and DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday' and (card_type = '4' or card_type = '5') ") or die(mysql_error());
//  echo $q1;
  while($row2 = mysql_fetch_array($q1)){
?>
...
<?php } ?>
                       ...
                       <div class="card-content"><a href="dashboard-trans-yesterdays-list-view-four.php">
                                    <p class="category"><img src="icons/car.png"  style="width:60px">4 Wheeler Entry</p>
                                                                                                          <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec FROM details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday' and vehicle_type = '4' and (card_type = '4' or card_type = '5')") or die(mysql_error());
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                     ...
                     <div class="card-content"><a href= "list-view-transaction.php"><a href="dashboard-trans-yesterdays-list-view_4w_Exit.php">
                                    <p class="category"><img src="icons/car.png"  style="width:60px">4 Wheeler Exit </p>
                                                                        <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT COUNT(vehicle_type) as vec FROM details_transaction where vehicle_type = '4' and DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday' and status = '1' and (card_type = '4' or card_type = '5')") or die(mysql_error());
...
<div class="col-lg-3 col-md-6 col-sm-6">
                       ...
                       <div class="card-content"><a href="4w-on-premises_yesterday.php">
                                    <p class="category"><img src="icons/transaction.png"  style="width:60px">'Overnight 4W</p>
                                                                                                          
<?php
$q1 =  mysql_query("SELECT COUNT(transaction_id) as statu FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday' and vehicle_type = '4' AND manual_vop_update = 1 and card_type = '4' ") or die(mysql_error());
   ...
   <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="dashboard-trans-yesterdays-list-view-four.php">
                                    ...
                                    <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT SUM(amount) as sum FROM `details_transaction`  where vehicle_type = '4' and DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday' and (card_type = '4' or card_type = '5') ") or die(mysql_error()); 
//  echo $q1;
  while($row2 = mysql_fetch_array($q1)){
?>
                                    <h3 class="card-title">₹<?php echo $row2['sum'];?></h3></a>
...
<div class="col-lg-3 col-md-6 col-sm-6">
                       ...
                       <div class="card-content"><a href="yesterday-regular.php">
                                    <p class="category"><img src="icons/transaction.png"  style="width:60px">Regular</p>
                                                                                                          <?php 
  //$dept=$_POST['department'];
  $q1 =  mysql_query("SELECT COUNT(transaction_id) as statu FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday'  AND area = '0' and (card_type = '4' or card_type = '5') ") or die(mysql_error());
...
<div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="card-content"><a href= "list-view-transaction.php"><a href="yesterday-premium.php">
                                    <p class="category"><img src="icons/transaction.png" style="width:60px"> Premium</p>
                                                                        <?php 
  //$dept=$_POST['department'];
         ...
         <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content"><a href="yesterday-premium.php">
                                    <p class="category"><img src="icons/car.png"  style="width:60px">Premium Amt</p>
                                    <?php 
  //$dept=$_POST['department'];
 // $q1 =  mysql_query("SELECT count(*) FROM `details_transaction`  where vehicle_type = '2'  and DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday'  and (TIME_TO_SEC(exit_time) - TIME_TO_SEC(entry_time)) <= 900 and (card_type = '4' or card_type = '5')") or die(mysql_error());
     $q1 =  mysql_query("SELECT SUM(amount) as sum FROM `details_transaction`  where vehicle_type = '4' and DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday' and area = 1") or die(mysql_error());
//  echo $q1;
  while($row2 = mysql_fetch_array($q1)){
?>
                                    <h3 class="card-title"><?php echo $row2['sum'];?></h3></a>
...
<div class="col-lg-3 col-md-6 col-sm-6">
                         ...
                         <p class="category"><img src="icons/redemption.png" style="width:60px"> Foc</p>
                                    <?php 
  //$dept=$_POST['department'];
    $q1 =  mysql_query("SELECT COUNT(foc) as statu FROM  details_transaction where DATE_FORMAT(entry_time,'%Y-%m-%d') = '$yesterday' and foc = '1' and (card_type = '4' or card_type = '5') ") or die(mysql_error());
//  echo $q1;
  while($row2 = mysql_fetch_array($q1)){
?>
                                    <h3 class="card-title"><?php echo $row2['statu'];?></h3></a>
