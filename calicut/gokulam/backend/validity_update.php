...
include("config.php");
//$db = mysqli_connect('localhost','root','mysqlpwd1','letspark');
...
mysql_query("UPDATE employee_allocation SET valid_to= '$date' where id = '$selected'");
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Card Validity Updation</a>
                    </div>
                    ...
                    <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Card Validity Details</h4>
									
									<form action="" method="post">
										<input type="date" name="valid_to"  required style="margin-left:0.5%">
...
if ($card_type != "")
{
	$query = sprintf("SELECT employee_allocation.id,employee_allocation.card_type,CASE
