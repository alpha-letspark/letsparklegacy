			...
			<div class="row">
				...
				<div class="col s6">
					<div class="content-center">
						<a href="index.html"><h1><span>GOKULAM</span> MALL</h1></a>
					</div>
				</div>
				<div class="col s3">
					<div class="content-right">
					<!--	<a href="contact.html"><i class="material-icons">mail_outline</i></a>-->
					</div>
				</div>
			</div>
		</div>
	...
	<div class="team segments">
		<div class="container">
			...
			<div class="row">
				...
				<div align="center"><a href="articles.html">	<img src="images/car.png"  style="width: 150px;" alt=""></a></div>
						<div class="text" align="center">

                            <h3>Total Slots  :  <?php echo $four ?></h3><br /><br />
							<h3>Slots in Use : <div id="show1">  </h3><br /><br />
						    <h2>Slots Available : <div style="color:green" id="show3"></div>  </h2>
						</div>
					</div>
				</div>
				<div class="col s6">
					<div class="contents z-depth-1">
					<div align="center"><a href="articles.html">	<img src="images/bike.png"  style="width: 150px;" alt=""></a></div>
						<div class="text" align="center">
							<h3>Total Slots  :  <?php echo $two ?></h3><br /><br />
							<h3>Slots in Use : <div id="show"></div>  </h3><br /><br />
							<h2>Slots Available : <div style="color:green" id="show2"></div>  </h2>
						</div>
					</div>
				</div>
